    ...
    post: async (req, res) => {
      ...
      const release = await Release
        .create({
          ...
          fixedPenaltyFine: fixedPenaltyFine || "",
          courtDate: courtDate || "",
          ...
          askedForDoctor: askedForDoctor || false,
          seenByDoctor: seenByDoctor || false,
          askedForMedication: askedForMedication || false,
          givenMedication: givenMedication || false,
